...
namespace TeamProjectForm1 {
    ...
    public partial class CustomersDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CustomersRow AddCustomersRow(string lastName, string firstName, string phoneNumber) {
...
namespace TeamProjectForm1.CustomersDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Customers` WHERE ((`ID` = ?) AND ((? = 1 AND `lastName` IS NULL) OR " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Customers` (`lastName`, `firstName`, `phoneNumber`) VALUES (?, ?, ?)" +
                "";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Customers` SET `lastName` = ?, `firstName` = ?, `phoneNumber` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `lastName` IS NULL) OR (`lastName` = ?)) AND ((? = 1 AND `firstName` IS NULL) OR (`firstName` = ?)) AND ((? = 1 AND `phoneNumber` IS NULL) OR (`phoneNumber` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TeamProjectForm1.Properties.Settings.Default.CustomersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, lastName, firstName, phoneNumber FROM Customers";
        ...
        public virtual int Delete(int Original_ID, string Original_lastName, string Original_firstName, string Original_phoneNumber) {
        ...
        public virtual int Insert(string lastName, string firstName, string phoneNumber) {
            if ((lastName == null)) {
        ...
        public virtual int Update(string lastName, string firstName, string phoneNumber, int Original_ID, string Original_lastName, string Original_firstName, string Original_phoneNumber) {
            if ((lastName == null)) {
